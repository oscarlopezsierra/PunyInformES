...
Constant TM_REUSABLE_MSG_EXIT "Con esto, das por terminada la conversación.";
#Endif;

#Ifndef TM_MSG_YOU;
Constant TM_MSG_YOU "Tú";
#Endif;

#Ifndef TM_MSG_TALK_ABOUT_WHAT;
[ TM_MSG_TALK_ABOUT_WHAT;
	print "Habla con ", (the) current_talker, " sobre:^";
];
#Endif;
...
Constant TM_MSG_NO_TOPICS "Ahora mismo, no sabrías de qué hablar.";
#Endif;
#Ifndef TM_MSG_EXIT_OPTION;
Constant TM_MSG_EXIT_OPTION "[ENTER] Terminar conversación";
#Endif;
